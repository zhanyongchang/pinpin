...
<body onLoad="iframe_height()">
    ...
    <div id="bodyheight">
        ...
        <div class="comment-form">
            ...
            <div class="posn">我的态度：<input type="radio" name="direction" value="1" /> <img src="<?php echo IMG_PATH;?>icon/zheng.png" /> <input type="radio" name="direction" value="2" /> <img src="<?php echo IMG_PATH;?>icon/fan.png" /> <input type="radio" name="direction" value="3" checked /> <img src="<?php echo IMG_PATH;?>icon/zhong.png" />
            </div>
...
<?php if(defined('IN_ADMIN') && !defined('HTML')) {echo '</div>';}?>
    ...
    <div class="hidden text-c" id="loading"><img src="<?php echo IMG_PATH;?>msg_img/loading.gif" /> 正在提交中...</div>
</body>
</html>