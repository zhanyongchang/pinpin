...
<tbody>
	...
	<tr id="trPosition" style="display:none;">
        ...
        <?php echo L('left_margin')?>：<input name='setting[paddleft]' id='PaddingLeft' type='text' size='5' value='0'class="input-text"> px&nbsp;&nbsp;
        <?php echo L('top_margin')?>：<input name='setting[paddtop]' id='PaddingTop' type='text' size='5' value='0' class="input-text" /> px
        </td>
    </tr>
	<tr id="SizeFormat">
		<th><strong><?php echo L('size_format')?>：</strong></th>
		<td><label><?php echo L('plate_width')?></label><input name="space[width]" id="s_width" class="input-text" type="text" value="990" size="10"> px &nbsp;&nbsp;&nbsp;&nbsp; <label><?php echo L('plate_height')?></label><input name="space[height]" type="text" id="h_height" class="input-text" value="300" size="10"> px</td>
	</tr>
	<tr>
