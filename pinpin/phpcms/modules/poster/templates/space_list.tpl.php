...
<div class="table-list">
    <table width="100%" cellspacing="0">
        <thead>
            <tr>
            <th width="10%" align="center"><input type="checkbox" value="" id="check_box" onclick="selectall('spaceid[]');"></th>
			<th><?php echo L('boardtype')?></th>
			<th width="33%" align="center" ><?php echo L('description')?></th>
...
?>   
	<tr>
	<td align="center">
	<input type="checkbox" name="spaceid[]" value="<?php echo $info['spaceid']?>"><?php echo $info['spaceid']?>
	</td>
