...
<div class="subnav">
    ...
    <?php echo admin::submenu($_GET['menuid'],$big_menu); ?><span>|
    </div>
</div>
...
<tbody>
    ...
    <tr>
		<th><?php echo L('poster_title')?>：</th>
		<td><input name="poster[name]" id="name" value="<?php echo $info['name']?>" class="input-text" type="text" size="50"></td>
	</tr>
	<tr>
...
<table width="100%"  class="table_form">
  ...
  <tr>
    <th width="80"><?php echo L('linkurl')?>：</th>
    <td class="y-bg"><input type="text" class="input-text" name="setting[images][1][linkurl]" id="linkurl3" size="50" value="<?php echo $info['setting'][1]['linkurl']?>" /></td>
  ...
  <tr>
    <th><?php echo L('alt')?>：</th>
    <td class="y-bg"><input type="text" class="input-text" name="setting[images][1][alt]" value="<?php echo $info['setting'][1]['alt']?>" id="alt3" size="50" /></td>
  </tr>
  </tbody>
</table>
<?php } ?>
