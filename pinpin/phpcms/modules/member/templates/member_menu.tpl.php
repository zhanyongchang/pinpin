...
<!--table_form_off-->
    ...
    <div class="bk15"></div>
	<div class="btn"><input type="submit" id="dosubmit" class="button" name="dosubmit" value="<?php echo L('submit')?>"/><input type="reset" name="Submit2" value="取消" class="button" onClick="history.go(-1)" /></div>
</div>
