...
<form name="myform" action="?m=member&c=member_setting&a=manage" method="post" id="myform">
    ...
    <div class="bk15"></div>
    <input name="dosubmit" type="submit" id="dosubmit" value="<?php echo L('submit')?>" class="button"><input type="reset" name="Submit2" value="取消" class="button" onClick="history.go(-1)" />
</form>
</div>
</div>
</body>
