...
<table cellpadding="2" cellspacing="1" class="table_form" width="100%">
    ...
    <tr>
		<th>电子邮件：</th>
		<td><input type="text" name="link[email]" id="link_email"
			size="30" class="input-text" value="<?php echo $email;?>"></td>
	</tr>
    <tr>
		<th>联系QQ：</th>
		<td><input type="text" name="link[qq]" id="link_qq"
			size="30" class="input-text" value="<?php echo $qq;?>"></td>
	</tr>
	<tr>
		<th><?php echo L('web_description')?>：</th>
		<td><textarea name="link[introduce]" id="introduce" cols="50"
			rows="5"><?php echo $introduce;?></textarea></td>
	</tr>
    <tr>
		<th>ip地址：</th>
		<td><?php echo $ip;?></td>
