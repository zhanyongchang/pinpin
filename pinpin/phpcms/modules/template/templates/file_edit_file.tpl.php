...
<textarea name="code" id="code" style="height: 600px;width:96%; visibility:inherit"><?php echo $data?></textarea>
<div class="bk10"></div>
...
<BR><input type="submit" id="dosubmit" class="button pt" name="dosubmit" value="<?php echo L('submit')?>" /> <input name="Submit2" type="reset" value="取消" class="button pt" onClick="history.go(-1)" />
</form>
</div>
</div>
