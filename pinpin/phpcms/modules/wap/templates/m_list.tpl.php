...
<!--
	...
	window.top.art.dialog({title:'<?php echo L('edit')?>--'+name, id:'edit', iframe:'?m=wap&c=wap_admin&a=edit&siteid='+siteid ,width:'700px',height:'550px'}, 	function(){var d = window.top.art.dialog({id:'edit'}).data.iframe;
