...
<head>
    ...
    <meta charset="utf-8" />
    <style type="text/css">
    body,div,ul,ol,li,dl,dt,dd,p,span,h1,h2,h3,h4,h5,h6,form {margin:0;padding:0;font-size:12px;}	
    .content {padding:0px 15px;}
    .content p {line-height:1.5;}
    .left {float:left;}
    .cLineB {overflow:hidden;padding:5px 0;border-bottom:1px solid #EEEEEE;}
    .clr,.clear {display:block;clear:both;height:1px;overflow:hidden;}
    </style>
</head>
<body>
    <div class="content">
        <div class="cLineB">
            <h4 class="left">一键导航 </h4><br /><br />
            <div style="padding-bottom:10px;">
                <p><span class="bold">移动红点生成导航连接!</span>将生成的导航连接复制到需要的地方！</p>
                <p><span class="bold">一键导航生成连接：</span><br /><textarea  onclick="this.select();" id="url" style="width:100%;border: hidden;overflow:hidden;background:#f9edbe;color:#C0C;"></textarea><span class="red">请注意标题字数和地址字数，过长的导航url可能会被截断导致导航页面错误！如果一定要很长，请将生成的url进行缩短处理！建议标题10字内，地址20字内！</span></p>
            </div>
            <div class="msgWrap form">
                标题：<input type="text" class="px" id="title" name="title" onChange="mkurl()" style="width:366px;" placeholder="请输入标题" /><br /><br />地址：<input type="text" class="px" id="suggestId" name="place" style="width:366px;" onChange="loadmap()" value="" />  经度：<input type="input" class="px" id="lng" required value="116.403859" name="lng" style="width:120px;" /> 纬度：<input type="input" required class="px" id="lat" value="39.915236"  name="lat" style="width:120px;" /><br />
                <div id="l-map" style="width:100%;height:700px;margin-top:10px;">        
                </div>
                <div id="r-result">
                    <input type="hidden" name="city" class="px" id="city" size="20" value="" />
                </div> 
    <script src="http://api.map.baidu.com/api?key=a258befb5804cb80bed5338c74dd1fd1&v=1.1&services=true" type="text/javascript"></script><script type="text/javascript"> 
    function mkurl(){
    ...
    //var point = new BMap.Point(116.403859,39.915236);  
    map.enableDragging();   
    map.enableContinuousZoom();
    map.addControl(new BMap.NavigationControl());  
    map.addControl(new BMap.ScaleControl());  
    map.addControl(new BMap.OverviewMapControl());
    var point = new BMap.Point(116.403859, 39.915236); //定义一个中心点坐标
    doit(point);
