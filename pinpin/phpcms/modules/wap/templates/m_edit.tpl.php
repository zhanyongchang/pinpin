...
<fieldset>
    ...
    <td class="y-bg"><input type="text" class="input-text" name="domain" id="domain" size="50" value="<?php echo $domain?>"/></td>
    </tr>
    <tr>
    <th>手机站Banner宽度：</th>
    <td class="y-bg"><input type="text" class="input-text" name="wap_bannerwidth" id="wap_bannerwidth" size="10" maxlength="8" value="<?php echo $wap_bannerwidth?>" /> </td>
    </tr>
    <tr>
    <th>手机站Banner高度：</th>
    <td class="y-bg"><input type="text" class="input-text" name="wap_bannerheight" id="wap_bannerheight" size="10" maxlength="8" value="<?php echo $wap_bannerheight?>" /> </td>
    </tr>
    ...
    <td class="y-bg"><textarea name="wap_mapcode" id="wap_mapcode" cols="60" rows="3" class="input-text"><?php echo $wap_mapcode?></textarea> </td>
    </tr>
    <tr>
    <th>手机站头部统计代码：</th>
    <td class="y-bg"><textarea name="wap_topcode" id="wap_topcode" cols="60" rows="5" class="input-text"><?php echo $wap_topcode?></textarea> </td>
    </tr>
    <tr>
    <th>手机站底部统计代码：</th>
    <td class="y-bg"><textarea name="wap_bottomcode" id="wap_bottomcode" cols="60" rows="5" class="input-text"><?php echo $wap_bottomcode?></textarea> </td>
    </tr>
    </table> 
  </fieldset>
 <div class="bk10"></div>
 <fieldset>
    ...
    <td class="y-bg">
 <textarea style="height: 100px; width: 90%;" id="options" cols="20" rows="2" name="setting[hotwords]"><?php echo $hotwords?></textarea><br />  <?php echo L('wap_hotword_desc')?>
</td>
    </tr>              
</table>
