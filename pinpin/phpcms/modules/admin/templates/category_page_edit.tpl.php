...
<table width="100%" class="table_form ">
      <tr>
        <th width="200">catid：</th>
        <td>
		    <?php echo $catid;?>
		</td>
      </tr>
      <tr>
        <th><?php echo L('parent_category')?>：</th>
        <td>
	...
	<tr>
        ...
        <td>
		<textarea name="info[description]" maxlength="255" style="width:500px;height:100px;"><?php echo $description;?></textarea>
		</td>
      </tr>
<tr>
...
<table width="100%" >
 ...
 <div class="bk15"></div>
    ...
    <input type="reset" name="Submit2" value="取消" class="button" onClick="history.go(-1)" />
</form>
</div>
