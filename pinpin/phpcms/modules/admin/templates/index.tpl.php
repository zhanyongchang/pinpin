...
<div class="header">
    ...
    <div class="rt-col">
    	<div class="tab_style white cut_line text-r"><a href="javascript:;" onclick="lock_screen()"><img src="<?php echo IMG_PATH.'icon/lockscreen.png'?>"> <?php echo L('lockscreen')?></a><span>|</span><span>|</span><a href="http://www.jzking.com/" target="_blank"><?php echo L('help')?></a>
    
        </div>
    </div>
    <div class="col-auto">
    	<div class="log white cut_line"><?php echo L('hello'),$admin_username?>  [<?php echo $rolename?>]<span>|</span><a href="?m=admin&c=index&a=public_logout" onClick="return confirm('确认要退出吗？');">[<?php echo L('exit')?>]</a><span>|</span>
