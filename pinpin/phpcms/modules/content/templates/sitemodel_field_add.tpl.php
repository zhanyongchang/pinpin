...
<option value="/^[0-9]{6}$/"><?php echo L('zip');?></option>
    ...
    <div class="btn"><input name="dosubmit" type="submit" value="<?php echo L('submit')?>" class="button"><input type="reset" name="Submit2" value="取消" class="button" onClick="history.go(-1)" /></div>
	</form>
