...
<tr>
    ...
    <td><input type="text" name="info[title]" id="title" value="<?php echo $title?>" style="width:400px;color:<?php echo $style;?>" class="measure-input " onBlur="$.post('api.php?op=get_keywords&number=3&sid='+Math.random()*5, {data:$('#title').val()}, function(data){if(data && $('#keywords').val()=='') $('#keywords').val(data); })"/>
...
<tr>
    <th> 描述</th>
    <td><textarea name="info[description]" id="description" rows="5" style="width:98%;"><?php echo $description?></textarea></td>
</tr>
<tr>
    <th> 备注</th>
    <td><textarea name="info[demo]" id="demo" rows="5" style="width:98%;"><?php echo $demo?></textarea></td>
</tr>
<tr>
...
<tr>
    <th> 排序</th>
    <td><input type="text" name="info[listorder]" id="listorder" value="<?php echo $listorder?>" size="10" maxlength="8"></td>
</tr>
</table>
</div>
<div class="bk10"></div>
