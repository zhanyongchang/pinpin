...
class form {
	...
	public static function editor($textareaid = 'content', $toolbar = 'basic', $module='', $catid='', $color = '', $allowupload = 0, $allowbrowser = 1,$alowuploadexts = '') {
		...
		if(!defined('EDITOR_INIT')) {
			$str .= '<script charset="utf-8" type="text/javascript" src="/statics/js/kindeditor/kindeditor.js"></script>';
			$str .= '<script charset="utf-8" type="text/javascript" src="/statics/js/kindeditor/lang/zh-CN.js"></script>';
